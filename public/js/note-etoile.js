document.addEventListener("DOMContentLoaded", function() {
    const etoiles = document.querySelectorAll(".material-symbols-outlined");
    ...
    function updateEtoile(note){
        etoiles.forEach((etoile, index) => {
            ...
            if (index < note) { 
                etoile.classList.add("actif");
                // iconElement.style.fill = "yellow"; // on ajoute la class 'actif' si la note (plus bas) est plus grande que l'index de l'etoile
