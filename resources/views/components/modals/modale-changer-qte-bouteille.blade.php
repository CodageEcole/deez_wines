<dialog class="modalePage">
    <form class="formulairePage" action="{{ route('cellier_quantite_bouteille.update', 'id-bouteille' )}}" method="POST">
        ...
        <div class="modaleActions">
            <button class="boutonCellier-cancel espace" type="submit">@lang('messages.save')<span class="material-symbols-outlined">check</span></button>
            <button class="boutonCellier-add espace">@lang('messages.cancel')<span class="material-symbols-outlined">close</span></button>
        </div>
    </form>
</dialog>